...
public class RSListViewAdapter extends BaseAdapter {

	private static final String TAG = "RSListViewAdapter";
	private Context context;
	private String rSR[];

	public RSListViewAdapter(Context context, String rSR[]) {
	...
	*****************************************************/
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			view = inflater.inflate(R.layout.route_search_list_item, null);
